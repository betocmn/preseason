  ...
  return (
    ...
    >
      <div className="container py-8">
        ...
        {/* Bottom row: copyright + legal on the left, X icon on the right */}
        <div className="flex flex-col items-start gap-3 text-xs text-muted-foreground/50 sm:flex-row sm:items-center sm:justify-between">
          ...
          <a
            ...
            className="inline-flex flex-shrink-0 items-center gap-1.5 text-muted-foreground transition-colors hover:text-foreground"
          >
            <svg
              viewBox="0 0 24 24"
              width="16"
            ...
            <span className="font-mono">@betocmn</span>
          </a>
        </div>
      </div>
    </footer>

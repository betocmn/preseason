/**
 * Database seed script — production-safe reference data only.
 * Run with: pnpm db:seed
 *
 * Seeds admin users, category groups, subcategories, tools, LLMs, and prompts.
 * Does NOT seed benchmark seasons, runs, critics, or comments.
 * For dev/test synthetic data, use: pnpm db:seed-dev
 *

...
import { PromptToolRanking } from '~/components/public/prompt-tool-ranking'
...
export default async function PromptDetailPage({ params }: Props) {
  ...
  const [promptComments, toolRankings] = await Promise.all([
    caller.comment.listByTarget({
      targetType: 'prompt',
      targetId: prompt.id,
    }),
    caller.prompt.getToolRankings({ promptId: prompt.id }),
  ])
